...
- Ingénierie logicielle: Git, Python, Pytest, Ruff, Uv, Mypy, Black, Flake8, Flask, Django, FastAPI
- Data Science: Scikit-Learn, Keras, Tensorflow, Spark, Pandas, Numpy, Matplotlib, Jupyter, MLFlow
- Data: Databricks, Delta Lake, PostgreSQL, SQLite, Datasette, Metabase
...
:   J'accompagne des entreprises dans l'industrialisation d'applications data et machine learning, que ce soit pour des cibles cloud ou edge.
    ...
    **Août 2023 - Aujourd'hui | Schneider Electric : Lead Technique Data et MLOps**<br>
    Au sein de l'équipe AI Solutions du AI Hub, industrialisation de use-cases d'intelligence artificielle dans les secteurs de l'automatisation industrielle et de la gestion énergétique intelligente : détection d'anomalies visuelles, maintenance prédictive industrielle, optimisation énergétique.
